...
public class HashTagsActivity extends Activity
{
	...
	ListView.OnItemClickListener historyListener = new ListView.OnItemClickListener()
	{
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id)
		{
			...
			// is the hashtag already in the target list?
			if(!mHashtags.contains(item))
			{
				// if not
				// add the item to the other (hashtagsListView) ListView
				mHashtags.add(item);
	...
	Button.OnClickListener mCreateListener = new Button.OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			{
				// insert the hashtag in the array list
...
//			}
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		// (
		historyListView = (ListView) findViewById(R.id.listview_history_hashtag);
		...
		// (
		hashtagListView = (ListView) findViewById(R.id.listview_hashtag);
